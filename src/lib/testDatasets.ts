...
export const testDatasets: TestDataset[] = [
  ...
  },
  {
    ...
    candidates: [
      ...
      { name: "Capitán América", surname: "Steve Rogers", location: "Brooklyn", group_name: "Marvel", age: 105, description: "Puedo hacer esto todo el día.", image_url: "https://images.unsplash.com/photo-1592853598064-211b56833d28?auto=format&fit=crop&w=400&q=80" },
      ...
      { name: "Batman", surname: "Bruce Wayne", location: "Gotham", group_name: "DC", age: 40, description: "Soy la noche. Soy la venganza. Soy Batman.", image_url: "https://images.unsplash.com/photo-1531259683007-016a943cdcdf?auto=format&fit=crop&w=400&q=80" },
      ...
      { name: "Doctor Strange", surname: "Stephen Strange", location: "Nueva York", group_name: "Marvel", age: 45, description: "Hechicero supremo, maestro de las artes místicas.", image_url: "https://images.unsplash.com/photo-1624213111452-35e8d3d5cc40?auto=format&fit=crop&w=400&q=80" },
    ],
  },
  {
    id: "world-desserts",
