	...
	theme: {
		...
		extend: {
			colors: {
				...
				avd: {
					bg:            'var(--avd-bg)',
					'bg-elev':     'var(--avd-bg-elev)',
					'bg-sunken':   'var(--avd-bg-sunken)',
					surface:       'var(--avd-surface)',
					border:        'var(--avd-border)',
					'border-soft': 'var(--avd-border-soft)',
					fg:            'var(--avd-fg)',
					'fg-muted':    'var(--avd-fg-muted)',
					'fg-subtle':   'var(--avd-fg-subtle)',
					'fg-faint':    'var(--avd-fg-faint)',
					brand:         'var(--avd-brand)',
					'brand-fg':    'var(--avd-brand-fg)',
					'brand-bg':    'var(--avd-brand-bg)',
					'brand-border':'var(--avd-brand-border)',
					'brand-subtle':'var(--avd-brand-subtle)',
					ok:            'var(--avd-ok)',
					'ok-fg':       'var(--avd-ok-fg)',
					'ok-bg':       'var(--avd-ok-bg)',
					warn:          'var(--avd-warn)',
					'warn-fg':     'var(--avd-warn-fg)',
					'warn-bg':     'var(--avd-warn-bg)',
					bad:           'var(--avd-bad)',
